...
class Metamorphic_Test:
    ...
    def lOOCV(self, label2):
        ...
        # print(self.df)
        # print(self.df.index[[2]])
        # pass
        count = 0
        for index in indices:
            testDf = self.df.loc[ [index] , : ].copy()
     
            trainingDf = self.df.drop([index])
    ...
    def metamorphic_Test_continious_attr(self, label1, label2, attributeIndex, mu = 0, sigmas = [0.2,0.5,1,2], repeatForEverySigma = 20 ):
        ...
        ori_attri, ori_label = self.convertDataFormat(df2)
        source_predictions = self.predict(self.classifier,ori_attri)       
        # print (source_prediction)      
        i = 0
        followup_predictions = np.empty(shape = [len(df2),repeatTime], dtype=int)
        for sigma in sigmas:
...
def experiment(name,label1,label2,repeatForEverySigma,attributeIndex,p_value,sigmas, classifierTypes = ['gaussianNB','3nn','5nn','10nn']):
...
# experiment(name = 'sensor_readings_24', label1=0,label2=1,attributeIndex=16,sigmas=[2],p_value=8.70272579e-01,repeatForEverySigma = 200)
# experiment(name = 'sensor_readings_24', label1=0,label2=1,attributeIndex=16,sigmas=[3],p_value=8.70272579e-01,repeatForEverySigma = 200)
# experiment(name = 'sensor_readings_24', label1=0,label2=1,attributeIndex=16,sigmas=[4],p_value=8.70272579e-01,repeatForEverySigma = 200)


# experiment(name = 'wine', label1=1,label2=2,attributeIndex=10,sigmas=[0.2],p_value=8.47388064e-01,repeatForEverySigma = 200)
# experiment(name = 'wine', label1=1,label2=2,attributeIndex=10,sigmas=[0.5],p_value=8.47388064e-01,repeatForEverySigma = 200)
# experiment(name = 'wine', label1=1,label2=2,attributeIndex=10,sigmas=[1],p_value=8.47388064e-01,repeatForEverySigma = 200)
# experiment(name = 'wine', label1=1,label2=2,attributeIndex=10,sigmas=[2],p_value=8.47388064e-01,repeatForEverySigma = 200)
# experiment(name = 'wine', label1=1,label2=2,attributeIndex=10,sigmas=[3],p_value=8.47388064e-01,repeatForEverySigma = 200)
# experiment(name = 'wine', label1=1,label2=2,attributeIndex=10,sigmas=[4],p_value=8.47388064e-01,repeatForEverySigma = 200)

# experiment(name = 'data_banknote_authentication', label1=0,label2=1,attributeIndex=3,sigmas=[0.2],p_value=3.85967572e-01,repeatForEverySigma = 200)
# experiment(name = 'data_banknote_authentication', label1=0,label2=1,attributeIndex=3,sigmas=[0.5],p_value=3.85967572e-01,repeatForEverySigma = 200)
# experiment(name = 'data_banknote_authentication', label1=0,label2=1,attributeIndex=3,sigmas=[1],p_value=3.85967572e-01,repeatForEverySigma = 200)
# experiment(name = 'data_banknote_authentication', label1=0,label2=1,attributeIndex=3,sigmas=[2],p_value=3.85967572e-01,repeatForEverySigma = 200)
# experiment(name = 'data_banknote_authentication', label1=0,label2=1,attributeIndex=3,sigmas=[3],p_value=3.85967572e-01,repeatForEverySigma = 200)
# experiment(name = 'data_banknote_authentication', label1=0,label2=1,attributeIndex=3,sigmas=[5],p_value=3.85967572e-01,repeatForEverySigma = 200)



# experiment(name = 'Frogs_MFCCs', label1=1,label2=2,attributeIndex=5,sigmas=[0.5],p_value=4.39976700e-01,repeatForEverySigma = 200)
# experiment(name = 'Frogs_MFCCs', label1=1,label2=2,attributeIndex=5,sigmas=[1],p_value=4.39976700e-01,repeatForEverySigma = 200)
# experiment(name = 'Frogs_MFCCs', label1=1,label2=2,attributeIndex=5,sigmas=[2],p_value=4.39976700e-01,repeatForEverySigma = 200)
# experiment(name = 'Frogs_MFCCs', label1=1,label2=2,attributeIndex=5,sigmas=[3],p_value=4.39976700e-01,repeatForEverySigma = 200)
# experiment(name = 'Frogs_MFCCs', label1=1,label2=2,attributeIndex=5,sigmas=[4],p_value=4.39976700e-01,repeatForEverySigma = 200)
# experiment(name = 'Frogs_MFCCs', label1=1,label2=2,attributeIndex=5,sigmas=[6],p_value=4.39976700e-01,repeatForEverySigma = 200)

experiment(name = 'avila-tr', label1=5,label2=0,attributeIndex=6,sigmas=[0.05],p_value=9.05291293e-01,repeatForEverySigma = 200)
# experiment(name = 'avila-tr', label1=0,label2=5,attributeIndex=6,sigmas=[0.2],p_value=9.05291293e-01,repeatForEverySigma = 200)
# experiment(name = 'avila-tr', label1=0,label2=5,attributeIndex=6,sigmas=[0.5],p_value=9.05291293e-01,repeatForEverySigma = 200)
# experiment(name = 'avila-tr', label1=0,label2=5,attributeIndex=6,sigmas=[1],p_value=9.05291293e-01,repeatForEverySigma = 200)
# experiment(name = 'avila-tr', label1=0,label2=5,attributeIndex=6,sigmas=[2],p_value=9.05291293e-01,repeatForEverySigma = 200)
# experiment(name = 'avila-tr', label1=0,label2=5,attributeIndex=6,sigmas=[3],p_value=9.05291293e-01,repeatForEverySigma = 200)
# experiment(name = 'avila-tr', label1=0,label2=5,attributeIndex=6,sigmas=[4],p_value=9.05291293e-01,repeatForEverySigma = 200)
