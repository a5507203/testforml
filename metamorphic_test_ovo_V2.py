...
class Metamorphic_Test:
    ...
    def metamorphic_Test_continious_attr(self, label1, label2, attributeIndex, mu = 0, sigmas = [0.2,0.5,1,2], repeatForEverySigma = 20 ):
        ...
        testIndices = np.random.choice(range(len(df2)), int(len(df2)*0.1), replace=False)
        # print(testIndices)
        # print(df2)
...
def experiment(name,label1,label2,repeatForEverySigma,attributeIndex,p_value,sigmas, classifierTypes = ['svm']): #'gaussianNB',

    p_value = str('{:.8e}'.format(p_value))
    data_url = './data_and_results_ovo_v2/'+name+'/'+name+'.data'
    ...
    for classifierType in classifierTypes:
        ...
        figurePath = './data_and_results_ovo_v2/'+name+'/'+p_value+'/'+classifierType
...
# experiment(name = 'sensor_readings_24', label1=0,label2=1,attributeIndex=16,sigmas=[0.5],p_value=8.70272579e-01,repeatForEverySigma =500)
# experiment(name = 'sensor_readings_24', label1=0,label2=1,attributeIndex=16,sigmas=[1],p_value=8.70272579e-01,repeatForEverySigma =500)
# experiment(name = 'sensor_readings_24', label1=0,label2=1,attributeIndex=16,sigmas=[2],p_value=8.70272579e-01,repeatForEverySigma =500)
# experiment(name = 'sensor_readings_24', label1=0,label2=1,attributeIndex=16,sigmas=[3],p_value=8.70272579e-01,repeatForEverySigma =500)
# experiment(name = 'sensor_readings_24', label1=0,label2=1,attributeIndex=16,sigmas=[4],p_value=8.70272579e-01,repeatForEverySigma =500)


# experiment(name = 'wine', label1=1,label2=2,attributeIndex=10,sigmas=[0.5],p_value=8.47388064e-01,repeatForEverySigma =500)
# experiment(name = 'wine', label1=1,label2=2,attributeIndex=10,sigmas=[1],p_value=8.47388064e-01,repeatForEverySigma =500)
# experiment(name = 'wine', label1=1,label2=2,attributeIndex=10,sigmas=[2],p_value=8.47388064e-01,repeatForEverySigma =500)
# experiment(name = 'wine', label1=1,label2=2,attributeIndex=10,sigmas=[3],p_value=8.47388064e-01,repeatForEverySigma =500)
# experiment(name = 'wine', label1=1,label2=2,attributeIndex=10,sigmas=[4],p_value=8.47388064e-01,repeatForEverySigma =500)

# experiment(name = 'data_banknote_authentication', label1=0,label2=1,attributeIndex=3,sigmas=[0.5],p_value=3.85967572e-01,repeatForEverySigma =500)
# experiment(name = 'data_banknote_authentication', label1=0,label2=1,attributeIndex=3,sigmas=[1],p_value=3.85967572e-01,repeatForEverySigma =500)
# experiment(name = 'data_banknote_authentication', label1=0,label2=1,attributeIndex=3,sigmas=[2],p_value=3.85967572e-01,repeatForEverySigma =500)
# experiment(name = 'data_banknote_authentication', label1=0,label2=1,attributeIndex=3,sigmas=[3],p_value=3.85967572e-01,repeatForEverySigma =500)
# experiment(name = 'data_banknote_authentication', label1=0,label2=1,attributeIndex=3,sigmas=[4],p_value=3.85967572e-01,repeatForEverySigma =500)



# experiment(name = 'Frogs_MFCCs', label1=1,label2=2,attributeIndex=5,sigmas=[0.5],p_value=4.39976700e-01,repeatForEverySigma =500)
# experiment(name = 'Frogs_MFCCs', label1=1,label2=2,attributeIndex=5,sigmas=[1],p_value=4.39976700e-01,repeatForEverySigma =500)
# experiment(name = 'Frogs_MFCCs', label1=1,label2=2,attributeIndex=5,sigmas=[2],p_value=4.39976700e-01,repeatForEverySigma =500)
# experiment(name = 'Frogs_MFCCs', label1=1,label2=2,attributeIndex=5,sigmas=[3],p_value=4.39976700e-01,repeatForEverySigma =500)
# experiment(name = 'Frogs_MFCCs', label1=1,label2=2,attributeIndex=5,sigmas=[4],p_value=4.39976700e-01,repeatForEverySigma =500)


experiment(name = 'avila-tr', label1=0,label2=5,attributeIndex=6,sigmas=[0.2],p_value=9.05291293e-01,repeatForEverySigma =500)
experiment(name = 'avila-tr', label1=0,label2=5,attributeIndex=6,sigmas=[0.5],p_value=9.05291293e-01,repeatForEverySigma =500)
experiment(name = 'avila-tr', label1=0,label2=5,attributeIndex=6,sigmas=[1],p_value=9.05291293e-01,repeatForEverySigma =500)
experiment(name = 'avila-tr', label1=0,label2=5,attributeIndex=6,sigmas=[2],p_value=9.05291293e-01,repeatForEverySigma =500)
# experiment(name = 'avila-tr', label1=0,label2=5,attributeIndex=6,sigmas=[3],p_value=9.05291293e-01,repeatForEverySigma =500)
# experiment(name = 'avila-tr', label1=0,label2=5,attributeIndex=6,sigmas=[4],p_value=9.05291293e-01,repeatForEverySigma =500)
